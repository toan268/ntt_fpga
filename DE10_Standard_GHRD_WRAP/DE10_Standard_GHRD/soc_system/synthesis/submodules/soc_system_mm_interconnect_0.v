...
module soc_system_mm_interconnect_0 (
	...
	wire  [147:0] address_span_extender_0_expanded_master_agent_cp_data;                                      // address_span_extender_0_expanded_master_agent:cp_data -> router:sink_data
	...
	wire          rsp_mux_src_valid;                                                                          // rsp_mux:src_valid -> address_span_extender_0_expanded_master_rsp_width_adapter:in_valid
	wire  [363:0] rsp_mux_src_data;                                                                           // rsp_mux:src_data -> address_span_extender_0_expanded_master_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                                          // address_span_extender_0_expanded_master_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                        // rsp_mux:src_channel -> address_span_extender_0_expanded_master_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                                  // rsp_mux:src_startofpacket -> address_span_extender_0_expanded_master_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                    // rsp_mux:src_endofpacket -> address_span_extender_0_expanded_master_rsp_width_adapter:in_endofpacket
	wire          address_span_extender_0_expanded_master_rsp_width_adapter_src_valid;                        // address_span_extender_0_expanded_master_rsp_width_adapter:out_valid -> address_span_extender_0_expanded_master_agent:rp_valid
	wire  [147:0] address_span_extender_0_expanded_master_rsp_width_adapter_src_data;                         // address_span_extender_0_expanded_master_rsp_width_adapter:out_data -> address_span_extender_0_expanded_master_agent:rp_data
	wire          address_span_extender_0_expanded_master_rsp_width_adapter_src_ready;                        // address_span_extender_0_expanded_master_agent:rp_ready -> address_span_extender_0_expanded_master_rsp_width_adapter:out_ready
	wire    [1:0] address_span_extender_0_expanded_master_rsp_width_adapter_src_channel;                      // address_span_extender_0_expanded_master_rsp_width_adapter:out_channel -> address_span_extender_0_expanded_master_agent:rp_channel
	wire          address_span_extender_0_expanded_master_rsp_width_adapter_src_startofpacket;                // address_span_extender_0_expanded_master_rsp_width_adapter:out_startofpacket -> address_span_extender_0_expanded_master_agent:rp_startofpacket
	wire          address_span_extender_0_expanded_master_rsp_width_adapter_src_endofpacket;                  // address_span_extender_0_expanded_master_rsp_width_adapter:out_endofpacket -> address_span_extender_0_expanded_master_agent:rp_endofpacket
	...
	wire          router_src_valid;                                                                           // router:src_valid -> address_span_extender_0_expanded_master_cmd_width_adapter:in_valid
	wire  [147:0] router_src_data;                                                                            // router:src_data -> address_span_extender_0_expanded_master_cmd_width_adapter:in_data
	wire          router_src_ready;                                                                           // address_span_extender_0_expanded_master_cmd_width_adapter:in_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                         // router:src_channel -> address_span_extender_0_expanded_master_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                                                   // router:src_startofpacket -> address_span_extender_0_expanded_master_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                                                     // router:src_endofpacket -> address_span_extender_0_expanded_master_cmd_width_adapter:in_endofpacket
	wire          address_span_extender_0_expanded_master_cmd_width_adapter_src_valid;                        // address_span_extender_0_expanded_master_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [363:0] address_span_extender_0_expanded_master_cmd_width_adapter_src_data;                         // address_span_extender_0_expanded_master_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          address_span_extender_0_expanded_master_cmd_width_adapter_src_ready;                        // cmd_demux:sink_ready -> address_span_extender_0_expanded_master_cmd_width_adapter:out_ready
	wire    [1:0] address_span_extender_0_expanded_master_cmd_width_adapter_src_channel;                      // address_span_extender_0_expanded_master_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          address_span_extender_0_expanded_master_cmd_width_adapter_src_startofpacket;                // address_span_extender_0_expanded_master_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          address_span_extender_0_expanded_master_cmd_width_adapter_src_endofpacket;                  // address_span_extender_0_expanded_master_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (address_span_extender_0_expanded_master_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (address_span_extender_0_expanded_master_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (address_span_extender_0_expanded_master_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (address_span_extender_0_expanded_master_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (address_span_extender_0_expanded_master_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (address_span_extender_0_expanded_master_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                                           // (terminated)
		.av_writeresponsevalid ()                                                                                            // (terminated)
	);
	...
	soc_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                               //       clk.clk
		.reset              (address_span_extender_0_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.sink_ready         (address_span_extender_0_expanded_master_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (address_span_extender_0_expanded_master_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (address_span_extender_0_expanded_master_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (address_span_extender_0_expanded_master_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (address_span_extender_0_expanded_master_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (address_span_extender_0_expanded_master_cmd_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) address_span_extender_0_expanded_master_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                               //       clk.clk
		.reset                (address_span_extender_0_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		...
		.out_endofpacket      (address_span_extender_0_expanded_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (address_span_extender_0_expanded_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (address_span_extender_0_expanded_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (address_span_extender_0_expanded_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (address_span_extender_0_expanded_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (address_span_extender_0_expanded_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) address_span_extender_0_expanded_master_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                               //       clk.clk
		.reset                (address_span_extender_0_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		...
		.out_endofpacket      (address_span_extender_0_expanded_master_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (address_span_extender_0_expanded_master_cmd_width_adapter_src_data),          //          .data
		.out_channel          (address_span_extender_0_expanded_master_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (address_span_extender_0_expanded_master_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (address_span_extender_0_expanded_master_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (address_span_extender_0_expanded_master_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                       // (terminated)
	);
